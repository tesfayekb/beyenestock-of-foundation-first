...
const SERVICES: ServiceDef[] = [
    ...
    // Data feeds
    {
        id: 'databento',
        name: 'Databento',
        purpose: 'OPRA real-time options trade feed (SPXW/SPX) + historical OPRA archive from 2013-04-01 (12+ yr depth)',
        costMonthly: 199,
        costNote: 'OPRA Standard tier; renews 2026-06-01',
    ...
    {
        id: 'polygon_options',
        name: 'Polygon.io — Options Developer',
        purpose: 'Historical options chains, Greeks/IV/Open Interest, technical indicators, minute aggregates (4yr historical, 15-min delayed quotes)',
        costMonthly: 79,
    ...
    {
        id: 'polygon_stocks',
        name: 'Polygon.io — Stocks Advanced',
        purpose: 'Real-time equities (no delay), 20+ yr historical, Polygon News, cross-asset signals (HYG/TLT/DXY) — Item 15A + 15D coverage',
        costMonthly: 199,
        costNote: 'Individual Use — Non-pros only',
        dashboardUrl: 'https://polygon.io/dashboard',
        keyId: 'polygon',
        healthServiceName: 'polygon_feed',
        category: 'data',
