...
export const ALL_FEATURES: FeatureDefinition[] = [
    ...
    // ── Signal enhancements (default ON when built) ───────────────────
    {
        ...
        category: 'signal',
        description:
            'Reduces size or skips when the VIX term structure inverts.',
        activationThreshold: null,
        thresholdType: null,
        autoEnable: false,
    ...
    },
    {
        ...
        category: 'signal',
        description:
            'Only enters in optimal windows: 9:45-10:15 AM and 12:30-1:30 PM ET.',
        activationThreshold: null,
        thresholdType: null,
        autoEnable: false,
        builtStatus: 'not_built',
    },
    {
        ...
        category: 'signal',
        description:
            'Uses GEX net sign to choose between condor and directional strategies.',
        activationThreshold: null,
        thresholdType: null,
        autoEnable: false,
        builtStatus: 'not_built',
