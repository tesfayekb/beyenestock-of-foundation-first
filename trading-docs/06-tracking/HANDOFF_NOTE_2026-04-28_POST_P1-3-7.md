...
### A.7 Silent-failure-class family — when "valid math, degenerate semantics" produces zero-class outputs that look benign in isolation but break downstream contracts (added 2026-05-03 from cv_stress design memo finding; **family FULLY CLOSED 2026-05-02 via T-ACT-047**; convention pointer for future agents)
...
This family includes (2026-05-02 — **5 members, FAMILY CLOSED**):
...
**Family closure verdict (2026-05-02):** A.5, A.6, T-ACT-046, T-ACT-054, T-ACT-047 — all 5 members of the silent-failure-class family have been remediated, tested, and ratified into convention. The family is FULLY CLOSED. Future incidents matching either vector should reference A.7 as the precedent and use either the T-ACT-054 (derived-feature) or T-ACT-047 (persist-site) implementation as the canonical template.
